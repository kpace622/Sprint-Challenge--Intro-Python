...
print("Starts with D:")
a = [string.name for string in humans if string.name.startswith("D")]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [str.name for str in humans if str.name.endswith("e")]
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")                                                  
c = [x.name for x in humans if "C" or "D" or "E" or "F" or "G" in humans]
print(c)
